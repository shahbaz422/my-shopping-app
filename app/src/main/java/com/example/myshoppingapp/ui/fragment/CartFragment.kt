...
import com.example.myshoppingapp.ui.activity.AddressActivity
...
class CartFragment : Fragment() {
    ...
    private fun totalCost(data: List<ProductModel>?) {
        ...
        binding.totalItemCountText.text="Total items in your cart : ${data.size}"
        binding.totalCostText.text="Total Cost : $total"
