package com.example.myshoppingapp.ui.fragment
...
import com.example.myshoppingapp.databinding.FragmentHomeBinding
    ...
    private fun getProducts() {
        ...
        Firebase.firestore.collection("products")
            .get().addOnSuccessListener {
                ...
                binding.productRecycler.adapter= ProductAdapter(requireContext(),list)//if it crashes then remove //this.
            }
    }
        ...
        Firebase.firestore.collection("categories")
            .get().addOnSuccessListener {
                ...
                binding.categoryRecycler.adapter=
                    CategoryAdapter(requireContext(),list)//if it crashes then remove //this.
            }
    }
